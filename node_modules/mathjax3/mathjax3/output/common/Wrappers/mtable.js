...
function CommonMtableMixin(Base) {
    return (function (_super) {
        ...
        function class_1() {
            ...
            _this.findContainer();
            _this.isTop = (top && _this.container.node.isKind('math') && !_this.container.parent);
        ...
        class_1.prototype.stretchColumn = function (i, W) {
            ...
            if (count && nodeCount > 1) {
                ...
                try {
                    ...
                    try {
                        if (stretchy_1_1 && !stretchy_1_1.done && (_g = stretchy_1.return)) _g.call(stretchy_1);
                    }
                    finally { if (e_3) throw e_3.error; }
                }
            }
            var e_1, _c, e_2, _f, e_3, _g;
        };
        ...
        class_1.prototype.setColumnPWidths = function () {
            var W = this.cWidths;
            try {
                for (var _a = __values(this.pwidthCells), _b = _a.next(); !_b.done; _b = _a.next()) {
                    var _c = __read(_b.value, 2), cell = _c[0], i = _c[1];
