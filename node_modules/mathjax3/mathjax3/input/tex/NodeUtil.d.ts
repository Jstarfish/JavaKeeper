...
declare namespace NodeUtil {
    ...
    function getChildren(node: MmlNode): (MmlNode | TextNode)[];
    function getText(node: TextNode): string;
    function appendChildren(node: MmlNode, children: (MmlNode | TextNode)[]): void;
    ...
    function getChildAt(node: MmlNode, position: number): MmlNode | TextNode;
