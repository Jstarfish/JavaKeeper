...
- 可以简单的理解为“排好序的快速查找数据结构”，数据本身之外，<font color=#FF0000>**数据库还维护者一个满足特定查找算法的数据结构**</font>，这些数据结构以某种方式引用（指向）数据，这样就可以在这些数据结构上实现高级查找算法。这种数据结构，就是索引。
  ...
  ![](https://cdn.jsdelivr.net/gh/Jstarfish/picBed/mysql/search-index-demo.png)
...
![](https://cdn.jsdelivr.net/gh/Jstarfish/picBed/mysql/BTree-vs-B+Tree.png)
...
![](https://cdn.jsdelivr.net/gh/Jstarfish/picBed/mysql/MySQL-B+Tree-store.png)
