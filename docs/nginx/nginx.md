...
这回设置nginx 监听端口为9999，取个天长地久的意思

访问 http://127.0.0.1:9999/java/ 直接跳转到 127.0.0.1:8080

访问 http://127.0.0.1:9999/egg/ 直接跳转到 127.0.0.1:8081

1. 在服务器上起两个tomcat，修改其中一个端口号为8081； 顺便修改下tomcat欢迎页（apache-tomcat-9.0.29-8081/webapps/ROOT目录下的index.jsp），看到下图加了一个大大的“蛋蛋”不
...
![image-20191209112256537](C:\Users\jiahaixin\AppData\Roaming\Typora\typora-user-images\image-20191209112256537.png)
...
/home/sync360/apache-tomcat-7.0.65/webapps/dmpproduct.war