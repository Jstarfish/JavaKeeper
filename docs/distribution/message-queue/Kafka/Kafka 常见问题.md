> 面试时，对 MQ 知识的考察离不开这几个问题，如何确保消息 100% 不丢失？有顺序？不重复？消息积压怎么办？
...
![](https://s0.lgstatic.com/i/image/M00/8F/79/Ciqc1GAIDXuAZ2iUAAIGj0vJThg862.png)

## Kafka 消息保序问题

从业务上把需要有序的打到同一个partition，大多数情况只需要业务上保证有序就可以，不用全局有序
